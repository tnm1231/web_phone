                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-register-form mt-2" action="{{ Route('adminRegister') }}" method="POST">
                                    @csrf
                                    {{-- @if ($errors->any())
                                    ...
                                    <div class="demo-spacing-0">
                                        <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                                            <div class="alert-body d-flex align-items-center">
                                                ...
                                                <span>The value is <strong>invalid</strong>.{{ $error }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" id="fullname" type="text" name="fullname" placeholder="Enter your fullname" aria-describedby="register-username" autofocus="" tabindex="1" />
                                    </div>
                                    <div class="mb-1">
                                        <label class="form-label" for="register-email">Email</label>
                                        <input class="form-control" id="email" type="text" name="email" placeholder="Enter your email" aria-describedby="register-email" tabindex="2" />
                                    </div>
                                    <div class="mb-1">
                                    ...
                                    <div class="mb-1">
                                        <label class="form-label" for="register-password">Re_Password</label>
                                        <div class="input-group input-group-merge form-password-toggle">
                                            <input class="form-control form-control-merge" id="repassword" type="password" name="repassword" placeholder="············" aria-describedby="register-password" tabindex="3" /><span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                                        </div>
                                    </div>
                                    <div class="mb-1">
                                        <div class="form-check">
                                            <input class="form-check-input" id="register-privacy-policy" name="agree" type="checkbox" tabindex="4" />
                                ...
                                <p class="text-center mt-2"><span>Already have an account?</span><a href="/admin/login"><span>&nbsp;Sign in instead</span></a></p>
