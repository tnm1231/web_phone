                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-1">
                                <div class="row">
                                    <div class="col-md-12">
                                    <label class="form-label" for="basicInput">Main Banner 1</label>
                            ...
                            <div class="mb-1">
                                <div class="row">
                                    <div class="col-md-12">
                                    <label class="form-label" for="basicInput">Main Banner 2</label>
                                    <div class="input-group">
                                        <input id="banner2" name="image2" placeholder="Example image below 770x475px" class="form-control" >
                            ...
                            <div class="mb-1">
                                <div class="row">
                                    <div class="col-md-12">
                                    <label class="form-label" for="basicInput">Main Banner 3</label>
                                    <div class="input-group">
                                        <input id="banner3" name="image3" placeholder="Example image below 770x475px" class="form-control" >
                            ...
                            <div class="mb-1">
                                <div class="row">
                                    ...
                                    <div class="input-group">
                                        <input id="banner4" name="image4" placeholder="Example image below 1170x400px" class="form-control" >
